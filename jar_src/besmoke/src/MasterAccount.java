...
public class MasterAccount extends Account {
    ...
    public static MasterAccount getMasterAccount() {
        try {
            FileInputStream fIn = new FileInputStream("./Resources/Data/maccount.ser");
            ...
            System.out.println("getMasterAccount() exception: " + e);
            return null;
        }
    }
    ...
    private void update() {
        ...
        try {
            FileOutputStream fOut = new FileOutputStream("./Resources/Data/maccount.ser");
